...
#define NUM_THREAD_POLYNOMIAL 8 //numero di thread supplementari per calcolare i polinomi di siqs
...
//diminuire per trovare meno numeri B_smooth potenziali ma minor computazione,valore default=25,non è il contrario? più è grande e più è difficile avere numeri B-smooth di quel tipo,ma i numeri che passano la soglia sono più probabilmente B_smooth
